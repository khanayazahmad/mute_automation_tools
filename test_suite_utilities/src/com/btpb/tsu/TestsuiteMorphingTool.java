...
public class TestsuiteMorphingTool {
	...
	public TestsuiteMorphingTool(int mode){
		this.MODE = mode;
...
//				System.out.println(lines[i]);
	...
	void generateTestSuite(String pathToListFile){
		...
		try {
			...
			fw.flush();
			fw.close();
			Main.smdNumberingProvider(destinationPath+"\\Testcases\\smd", sourcePath+"\\Testcases\\smd");
	...
	public static void main(String[] args) {
		...
		TestsuiteMorphingTool r1 = new TestsuiteMorphingTool(4);
